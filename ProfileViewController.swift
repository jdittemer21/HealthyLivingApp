...
class ProfileViewController: UITableViewController
{
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        ...
        let completion: ((Bool, Error?) -> Void)! = {
            ...
            if !success {
                ...
                print("You didn't allow HealthKit to access these read/write data types. The error was: \(error). If you're using a simulator, try it on a device.")
    ...
    override func viewDidLoad()
    {
        ...
        self.userProfiles = [ProfileKeys.Age: [NSLocalizedString("Age (yrs)", comment: ""), NSLocalizedString("Not available", comment: "")],
                             ProfileKeys.Height: [NSLocalizedString("Height (inches)", comment: ""), NSLocalizedString("Not available", comment: "")],
                             ProfileKeys.Weight: [NSLocalizedString("Weight (pounds)", comment: ""), NSLocalizedString("Not available", comment: "")]]
    }
    ...
    private func saveHeightIntoHealthStore(_ height: Double) -> Void
    {
        ...
        let completion: ((Bool, Error?) -> Void) = {
            ...
            if !success {
                print("An error occured saving the height sample \(heightSample). The error was: \(error).")
